...
type Article struct {
	...
	TagModel     []Tag       `gorm:"many2many:article_tag" json:"tag_model"`     // 文章标签
	CommentModel []Comment   `gorm:"foreignKey:ArticleID" json:"comment_models"` // 文章评论列表
	UserModel    User        `gorm:"foreignKey:UserID" json:"user_model"`        // 文章作者
