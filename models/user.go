...
type User struct {
	...
	ArticleModel  []Article        `gorm:"foreignKey:UserID" json:"ArticleModels"`                                                              // 发布文章列表
	CollectsModel []Article        `gorm:"many2many:user_collects_models;joinForeignKey:UserID;joinReferences:ArticleID" json:"CollectsModels"` // 收藏文章列表
}
